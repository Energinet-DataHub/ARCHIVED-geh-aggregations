...
class AggregationResults:
    ...
    def __init__(self, net_exchange_per_neighbour, hourlyConsumption, hourlyProduction, flexConsumption, flex_consumption_with_system_correction_and_grid_loss, hourly_production_with_system_correction_and_grid_loss, combined_system_correction, combined_grid_loss):
