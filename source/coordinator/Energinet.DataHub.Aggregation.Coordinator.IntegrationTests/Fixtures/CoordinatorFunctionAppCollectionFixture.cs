...
namespace Energinet.DataHub.Aggregation.Coordinator.IntegrationTests.Fixtures
{
    ...
    /// </summary>
    [CollectionDefinition(nameof(CoordinatorFunctionAppCollectionFixture))]
    public class CoordinatorFunctionAppCollectionFixture : ICollectionFixture<CoordinatorFunctionAppFixture>
    {
    }
}
