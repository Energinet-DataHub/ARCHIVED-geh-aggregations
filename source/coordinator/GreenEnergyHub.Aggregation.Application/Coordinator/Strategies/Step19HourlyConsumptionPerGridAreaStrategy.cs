...
namespace GreenEnergyHub.Aggregation.Application.Coordinator.Strategies
{
    public class Step19HourlyConsumptionPerGridAreaStrategy : BaseStrategy<AggregationResultDto, AggregationResultMessage>, IDispatchStrategy
    {
        ...
        public Step19HourlyConsumptionPerGridAreaStrategy(ILogger<AggregationResultDto> logger, IMessageDispatcher messageDispatcher, GlnService glnService, IDistributionListService distributionListService)
