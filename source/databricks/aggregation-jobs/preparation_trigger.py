...
p.add('--grid-loss-system-correction-path', type=str, required=True, default="master-data/es-brp-relations", help='Path to es brp relations data storage location (deltalake) relative to root container')
