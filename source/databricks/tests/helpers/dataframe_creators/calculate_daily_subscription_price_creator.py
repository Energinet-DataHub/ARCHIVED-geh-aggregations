...
def calculate_daily_subscription_price_factory(spark):
    def factory(
        ...
        total_daily_subscription_price=Decimal,
        ...
        pandas_df = pd.DataFrame().append([{
            ...
            Colname.subcription_count: subcription_count,
            Colname.total_daily_subscription_price: total_daily_subscription_price,
