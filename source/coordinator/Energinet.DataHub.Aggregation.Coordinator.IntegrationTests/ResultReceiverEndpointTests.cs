...
namespace Energinet.DataHub.Aggregation.Coordinator.IntegrationTests
{
    ...
    public class ResultReceiverEndpointTests : FunctionAppTestBase<CoordinatorFunctionAppFixture>
    {
        public ResultReceiverEndpointTests(CoordinatorFunctionAppFixture fixture, ITestOutputHelper testOutputHelper)
        ...
        {
            const string requestUri = "api/" + CoordinatorFunctionNames.ResultReceiver;
            var request = new HttpRequestMessage(HttpMethod.Post, requestUri);

            request.Headers.Add("job-id", Guid.NewGuid().ToString());
            return request;
        }
    }
}
