...
{
    public class MarketRoleTestDataParser : TestDataParserBase<MarketRole>, ITestDataParser
    {
        public MarketRoleTestDataParser(IMasterDataStorage masterDataStorage, GeneratorSettings generatorSettings)
