...
namespace GreenEnergyHub.Aggregation.Application.Coordinator.Strategies
{
    public class Step14FlexConsumptionPerSupplierStrategy : BaseStrategy<AggregationResultDto, AggregationResultMessage>, IDispatchStrategy
    {
        ...
        public Step14FlexConsumptionPerSupplierStrategy(ILogger<AggregationResultDto> logger, IMessageDispatcher messageDispatcher, GlnService glnService, IDistributionListService distributionListService)
