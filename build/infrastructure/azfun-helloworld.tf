...
module "azfun_helloworld" {
  source                                    = "git::https://github.com/Energinet-DataHub.git/geh-terraform-modules//function-app?ref=1.0.0"
...
module "azfun_helloworld_plan" {
  source              = "git::https://github.com/Energinet-DataHub.git/geh-terraform-modules//app-service-plan?ref=1.0.0"
...
module "azfun_helloworld_stor" {
  source                    = "git::https://github.com/Energinet-DataHub.git/geh-terraform-modules//storage-account?ref=1.0.0"
