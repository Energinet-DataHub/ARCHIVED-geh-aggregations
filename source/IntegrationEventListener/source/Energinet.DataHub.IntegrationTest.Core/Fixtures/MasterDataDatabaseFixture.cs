...
namespace GreenEnergyHub.Charges.IntegrationTest.Core.Fixtures.Database
{
    ...
    /// </summary>
    public sealed class MasterDataDatabaseFixture : IAsyncLifetime
    {
        public MasterDataDatabaseFixture()
        {
            DatabaseManager = new MasterDataDatabaseManager();
        }

        public MasterDataDatabaseManager DatabaseManager { get; }
